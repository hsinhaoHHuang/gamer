...
#  elif ( MODEL == ELBDM )
   Idx_Dens1   = AddField( "Dens1",    NORMALIZE_NO );
   Idx_Real1   = AddField( "Real1",    NORMALIZE_NO );
   Idx_Imag1   = AddField( "Imag1",    NORMALIZE_NO );
   Idx_Dens2   = AddField( "Dens2",    NORMALIZE_NO );
   Idx_Real2   = AddField( "Real2",    NORMALIZE_NO );
   Idx_Imag2   = AddField( "Imag2",    NORMALIZE_NO );
