...
#elif ( MODEL == ELBDM )
SET_GLOBAL( FieldIdx_t Idx_Dens1,         Idx_Undefined );
SET_GLOBAL( FieldIdx_t Idx_Real1,         Idx_Undefined );
SET_GLOBAL( FieldIdx_t Idx_Imag1,         Idx_Undefined );
SET_GLOBAL( FieldIdx_t Idx_Dens2,         Idx_Undefined );
SET_GLOBAL( FieldIdx_t Idx_Real2,         Idx_Undefined );
SET_GLOBAL( FieldIdx_t Idx_Imag2,         Idx_Undefined );
