...
for ds in ts.piter():
    ...
    fields_list  = [ 'density', 'temperature', 'kinetic_energy_density', 'velocity_magnitude', 'resolution_size' ]
    pfields_list = [ ('all', 'particle_mass'), ('Halo', 'particle_mass'), ('Disk', 'particle_mass') ]

    if ds.current_time > ds.quan( 20.0, 'Myr'):
        pfields_list.append( ('new_star', 'particle_mass') )

    if code == 'GAMER':
        fields_list.append( 'particle_density_on_grid' )
        pfields_list.append( ('expSNeII', 'particle_mass') )
    ...
    for zoom_mode in ['b', 'c', 'm', 'n']:
        ...
        for direction in ['y', 'z']:
            for field in fields_list:
                ...
                project_unit = '' if field == 'temperature' or field == 'resolution_size' else '*pc'
